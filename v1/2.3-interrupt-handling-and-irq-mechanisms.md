...
The “top half” (ISR) runs quickly to acknowledge the hardware. The “bottom half” (softirq, tasklet, or kthread) handles heavier work later. This split design prevents the CPU from being stuck in interrupt mode for too long, which would block other important events.
